...
<section class="stark-login">
  <form action="" method="">	
    <div id="fade-box">
      <input type="text" name="username" v-model="userName" id="用户名" placeholder="用户名" required>
...
export default {
    ...
    validateDate(){
      ...
      if(this.userName&&this.password){
        ...
        this.userName!=userName&&alert("你输入的账号不正确");
        this.password!=password&&alert("你输入的密码不正确");
